...
void loop()
{
	...
	if (servo_pitch_tmp < 72)
		servo_pitch_tmp = 72;
	else if (servo_pitch_tmp > 108)
		servo_pitch_tmp = 108;
	else
		servo_pitch_tmp = int(servo_pitch_tmp);
	...
	if (servo_roll_tmp < 72)
		servo_roll_tmp = 72;
	else if (servo_roll_tmp > 108)
		servo_roll_tmp = 108;
	else
		servo_roll_tmp = int(servo_roll_tmp);
...
/**
 * @brief Read MPU6050 acc, temp, gyro data
 * 
 */
...
/**
 * @brief Setup mpu 6050 registers
 * 
 */
